...
class Character:
    ...
    def attack(self, target: Character):
        ...
        print(f"{self._name} attack with {damages} damages in your ass ! (attack: {self._attack_value} + roll: {damages - self._attack_value})")
...
if __name__ == "__main__":
    ...
    character1 = Character("Matheo", 20, 8, 3, Dice(6))
    character2 = Character("Lukas", 20, 8, 3, Dice(6))
    print(character1)
    print(character2)
